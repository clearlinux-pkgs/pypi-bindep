...
Source0  : https://files.pythonhosted.org/packages/e9/e4/fdefd8289e79f3a2f9f692f9ef64b0c835856dd023f335c96c8225e776cb/bindep-2.13.0.tar.gz
...
%prep
%setup -q -n bindep-2.13.0
cd %{_builddir}/bindep-2.13.0
pushd ..
cp -a bindep-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742918532
